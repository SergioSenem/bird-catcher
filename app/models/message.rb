class Message < ApplicationRecord
	...
	def get_messages_from_twitter
		tweets = get_tweets
		save_tweets(tweets)
	end

	def get_hashtag_messages_from_twitter(hashtag)
	...
	def get_tweets
  	...
  	def get_tweets_by_hashtag(client, hashtag)
  	...
  	def save_hashtag_tweets(hashtag_id, tweets)
  		tweets.each do |tweet|	
  	...
  	def save_message_from_tweet(tweet)
  		message = Message.new
  	...
  	def save_hashtag_message(hashtag_id, message_id)
